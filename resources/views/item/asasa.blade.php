                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <form method="POST" onsubmit="return {{$item->status ? 'true' : 'false'}}"
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="returner_name" class="mt-1 block w-full bg-transparent" type="text"
                                    name="returner_name" required />
                            </div>

                            <div class="mt-4">
                                <x-input-label class="font-bold" for="remarks" :value="__('Remarks: ')" />
                                <textarea id="remarks" class="mt-1 block w-full bg-transparent" name="remarks" rows="4"
                                    required></textarea>
                            </div>
